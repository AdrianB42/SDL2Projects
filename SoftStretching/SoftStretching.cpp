...
bool Init() {
    ...
    else
    {
        ...
        window = SDL_CreateWindow("Soft Stretching", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
...
SDL_Surface* loadSurface(std::string path) {
    ...
    /*
    optimizedSurface will take the raw bmp surface and optimize it for blitting
    ...
    using have been 256bit, however a screen is typically 32bit), so every time the screen
